...
namespace WebCoreApp.Service.Repositores
{
    public class DiaryRepository : IDiaryRepository
    {
        ...
        public DiaryRepository(EFContext db, IHttpContextAccessor context, INotificationRepository notificationRepository)
        {
            _db = db;
            _context = context;
        ...
        public async Task<List<string>> SendDiary(int id)
        {
