...
namespace DataContext.Migrations
{
    ...
    [Migration("20180831062024_MyFirt")]
    partial class MyFirt
    {
            ...
            modelBuilder.Entity("DataContext.WebCoreApp.AppUser", b =>
                {
                    ...
                    b.HasOne("DataContext.WebCoreApp.TblCv", "MaCvNavigation")
                        .WithMany("AppUser")
                        .HasForeignKey("MaCv")
                        .HasConstraintName("FK_AppUser_tbl_CV");

                    b.HasOne("DataContext.WebCoreApp.TblTo", "MaToNavigation")
                        .WithMany("AppUser")
                        .HasForeignKey("MaTo")
            ...
            modelBuilder.Entity("DataContext.WebCoreApp.Permissions", b =>
                {
                    ...
                    b.HasOne("DataContext.WebCoreApp.AppRole", "Role")
                        .WithMany("Permissions")
