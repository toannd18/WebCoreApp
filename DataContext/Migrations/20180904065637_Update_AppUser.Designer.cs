...
namespace DataContext.Migrations
{
    ...
    [Migration("20180904065637_Update_AppUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataContext.WebCoreApp.AppUser", b =>
                {
                    b.HasOne("DataContext.WebCoreApp.TblBp")
                        .WithMany("AppUser")
                        .HasForeignKey("MaBp");

                    b.HasOne("DataContext.WebCoreApp.TblCv")
                        .WithMany("AppUser")
                        .HasForeignKey("MaCv");

                    b.HasOne("DataContext.WebCoreApp.TblTo")
                        .WithMany("AppUser")
                        .HasForeignKey("MaTo");
                });
